...
public class xpathCSS {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// xpath with text()function //tagname[text()='text of link'],, text() used only
		// for links
		driver.findElement(By.xpath("//a[text()='Forgot your password?']")).click();

		// to wait till the transition of screen completes otherwise locators will not
		// be found
		Thread.sleep(1000);
		...
		// xpath with multiples attributes of same element
		// //tagname[@attribute1='value1' and @attribute1='value1']
		...
		// xpath with parent to child tag - personally dnt recommend. will not find
		// unique locator
		driver.findElement(By.xpath("//form/input[1]")).clear();

		// xpath with attribute which is not unique but can be used with index
		// //tagname[@attribute='value'][index]
		driver.findElement(By.xpath("//input[@type='text'][2]")).clear();

		// xpath using conatins()function ,//tagname[contains(@attribute,'value')] =
		// will not comes in contain function, //tagname[contains(text(),'value')]
		driver.findElement(By.xpath("//input[contains(@placeholder,'Phone')]")).clear();

		// xpath with parent attribute and similar child tag with index which can
		// traverse with / //tagname[@attribute='value']/tagname[index]
		...
		// xpath with sibling traverse /following-sibling::tag[index]
		System.out.println(driver.findElement(By.xpath("//div/button[1]/following-sibling::button[2]")).getText());

		// xpath with child to parent traverse /parent::tag
